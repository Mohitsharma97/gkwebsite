...
import {MDBView,MDBJumbotron,  MDBContainer, MDBRow, MDBCol, MDBIcon, MDBBtn, MDBInput } from "mdbreact";
        ...
        <MDBCol md="3" className="text-center">
          <ul className="list-unstyled mb-0">
            <li>
              ...
              <p> Registered Office<br/> <br/>453-454,4th Floor <br/>JMD,Megapolis,Sohna Road,<br/> Sector 48,Gurgaon,<br/>Haryana-122018</p>
            </li>
            <li>
            ...
            <li>
              ...
              <p> info@getkarigar.com <br/> helpdesk@getkarigar.com</p>   
            </li>
          </ul>
        </MDBCol>
      </MDBRow>
